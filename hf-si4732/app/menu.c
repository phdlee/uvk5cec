...
//VERSION 0.1M
		...
		case MENU_HFDUALWATCH:	//
			HF_DualWatch = gSubMenuSelection;
			break;
		case MENU_HFDUALVOL:	//
			HF_DualVol = gSubMenuSelection;
			//Set SI4735 Volume
			if (! isNeed4732Init)
				SI4735_setVolume(HF_DualVol);
			break;
...
//VESION 0.1P
		...
		case MENU_HFDUALWATCH:	//ICOM, YAESU ABOUT MAX 1000Khz
			gSubMenuSelection = HF_DualWatch;
			break;
		case MENU_HFDUALVOL:	//ICOM, YAESU ABOUT MAX 1000Khz
			gSubMenuSelection = HF_DualVol;
			break;
